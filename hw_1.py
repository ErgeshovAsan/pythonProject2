...
print(f'full name: {teacher.full_name}, age: {teacher.age}, is married: {teacher.is_married}, experience: {teacher.experience}')
...
for student in students:
    print(f'full name: {student.full_name}, age: {student.age}, is married: {student.is_married}, marks: {student.marks}')
